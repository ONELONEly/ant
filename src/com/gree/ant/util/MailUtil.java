...
public class MailUtil {
	...
	private static String getContent(String titl, String cono,String notes,String sys) {
		return "<HTML><HEAD><TITLE>GREE-ANT GNAW BONE 蚂蚁系统</TITLE>"
				...
				+ sys+">>>任务单号："+cono
				+ "("+ notes+ ") ;"
				+ "</U></FONT> 。 <FONT color=green>注：请及时<A HREF='http://10.1.18.83:8887/ant'>"+"登录"+"</A>"+"系统处理。亲，记得用Chrome 谷歌浏览器登录！</FONT></LI></TD></TR></TR>"
				+ "<TR>"
				+ "<TD colSpan=2>"
	...
	private static String getContent( String ptno,String grop) {
		return "<HTML><HEAD><TITLE>GREE-ANT GNAW BONE 蚂蚁系统</TITLE>"
				...
				+ "<FONT><U>"
				+ "请<A href='http://10.1.18.83:8887/ant/grade/printAllGrade?ptno=" +ptno
				+"'>下载</A>"
				+ "</U></FONT></LI></TD></TR></TR>"
				+ "<TR>"
				+ "<TD colSpan=2>"
	...
	private static String getContent( String csid,Long doid,String usid,String tilt) {
		return "<HTML><HEAD><TITLE>GREE-ANT GNAW BONE 蚂蚁系统</TITLE>"
				...
				+ "<FONT>"
				+ "<A href='http://10.1.18.83:8887/ant/doc/showDoc?doid=" +doid
				+"'>查看</A>"
