...
public class Tbuss003DAOImp_Ds implements Tbuss003DAO_Ds {
    ...
    public void insertRuleCustomerFieldTrackExt(Tbuss003VO tbuss003VO, int BugID, Cbase000VO cbase000VO){
    ...
    public void inserRuleBug(Tbuss003VO tbuss003VO, int BugID, int PersonID, String note_ds, int CrntVersionID){
        ...
        .set("SubProjectID",tbuss003VO.getSyno()).set("CrntVersionID",CrntVersionID).set("DateAssigned", DateUtil.formatYMDDate(tbuss003VO.getCdat())).set("PlanedStartDate", DateUtil.formatYMDDate(tbuss003VO.getCdat())).
                set("IssueFinishDate", DateUtil.formatYMDDate(tbuss003VO.getCdat())).  set("PlanedEndDate", DateUtil.formatYMDDate(tbuss003VO.getPdat())).  set("IssueActualStartDate", DateUtil.formatYMDDate(tbuss003VO.getPdat()))
