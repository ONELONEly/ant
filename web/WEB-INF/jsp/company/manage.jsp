...
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{url:'${base}/comp/queryAllComp',page:true,limit:10,limits:[10,15,20,25,30,50],id:'company'}" lay-filter="company">
        <thead>
        <tr>
            <th lay-data="{checkbox:true,width:50,fixed:true}"></th>
            <th lay-data="{field:'comp',align:'center',width:'30%',sort:true}">公司编号</th>
