...
<div class="x-body">
    ...
    <div class="layui-box">
        <table class="layui-table" lay-data="{height:'full-400',url:'${base}/grade/queryAll',initSort:{field:'pdat',type:'desc'},page:true,limit:10,limits:[10,15,20,25,30,50],id:'eva'}" lay-filter="eva">
            <thead>
            <tr>
