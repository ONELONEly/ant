...
<div class="x-body layui-container">
    <form class="layui-form layui-form-panel">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="NDAT" id="ndat" lay-verify="ndat" lay-search="">
                    ...
                    <option value="1" class="n-display" >一天</option>
                    <option value="2" class="n-display" >两天</option>
                    <option value="3" class="n-display" >三天</option>
                    <option value="4" class="n-display" >四天</option>
                    <option value="4" class="n-display" >五天</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="TYPE" lay-filter="type" id="type" lay-search>
                    ...
                    <option value="1" class="n-display" >靓仔</option>
                    <option value="2" class="n-display" >靓女</option>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="PROP" id="prop" placeholder="请输入权重" lay-verify="prop" autocomplete="off" class="layui-input" required/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="KRPROP" id="krprop" placeholder="请输入KR权重" lay-verify="krprop" autocomplete="off" class="layui-input" required/>
            </div>
        </div>
