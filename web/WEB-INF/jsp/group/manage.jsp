...
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{height:'full-400',url:'${base}/grop/queryAllGrop',page:true,limit:10,limits:[10,15,20,25,30,50],id:'group'}" lay-filter="group">
        <thead>
        <tr>
            <th lay-data="{checkbox:true,width:50,fixed:true}"></th>
            <th lay-data="{field:'grop',width:150,sort:true}">团队编号</th>
