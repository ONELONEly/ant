...
<div class="x-body layui-container">
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sadd" id="sadd" class="layui-input" lay-filter="sadd" autocomplete="off" lay-verify="sadd" required/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="tadd" id="tadd" class="layui-input" lay-filter="tadd" autocomplete="off" lay-verify="tadd" required/>
            </div>
        </div>

        <div class="layui-form-item">
            <button type="button" class="layui-btn layui-btn-radius" id="set" lay-filter="set" lay-submit>添加系统</button>
