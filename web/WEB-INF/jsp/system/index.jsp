...
<div class="x-nav">
    <span class="layui-breadcrumb">
        ...
        <a href="javascript:location.reload();" class="layui-btn layui-btn-radius layui-btn-small l-refresh" title="刷新"><i class="layui-icon l-center layui-icon-refresh"></i></a>
    </span>
</div>
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{url:'./queryUserRequire',page:true,limit:10,limits:[10,20,30,40,50],initSort:{field:'cdat',type:'desc'},id:'require'}" lay-filter="require">
        <thead>
            <tr>
                ...
                <th lay-data="{field:'taid',align:'center',width:150}">编号</th>
                <th lay-data="{field:'titl',align:'center',width:1000,toolbar:'#noteTpl'}">标题</th>
