...
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{height:'full-400',url:'./queryAllSystem',initSort:{field:'cdat',type:'desc'},page:true,limit:10,limits:[10,15,20,25,30,50],id:'system'}" lay-filter="system">
        <thead>
        <tr>
            <th lay-data="{fixed:true,checkbox:true,width:50}"></th>
            <th lay-data="{field:'syno',width:150}">系统编号</th>
            <th lay-data="{field:'dsca',width:150}">系统描述</th>
            <th lay-data="{field:'sadd',width:150}">正式地址</th>
            <th lay-data="{field:'tadd',width:150,sort:true}">测试地址</th>
