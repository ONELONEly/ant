...
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{height:'full-400',url:'./queryAllRole',page:true,limit:10,limits:[10,15,20,25,30,50],id:'role'}" lay-filter="role">
        <thead>
        <tr>
            <th lay-data="{checkbox:true,width:50,fixed:true}"></th>
            <th lay-data="{field:'roid',width:150,sort:true}">角色编号</th>
            <th lay-data="{field:'dsca',edit:true,width:150}">描述</th>
            <th lay-data="{field:'comp',width:150,sort:true}">公司编号</th>
            <th lay-data="{width:150,templet:'#shiro'}">权限</th>
            <th lay-data="{width:150,templet:'#user'}">用户</th>
