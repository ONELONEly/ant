...
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{height:'full-400',url:'${base}/task/queryAllGropTask',initSort:{field:'cdat',type:'desc'},page:true,limit:10,limits:[10,15,20,25,30,50],id:'manage'}" lay-filter="manage">
        <thead>
        <tr>
            <th lay-data="{fixed:true,checkbox:true,width:50}"></th>
            <th lay-data="{field:'taid',width:150,sort:true}">编号</th>
