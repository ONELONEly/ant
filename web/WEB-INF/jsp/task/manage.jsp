...
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{url:'${base}/task/queryAllGropTask',initSort:{field:'cdat',type:'desc'},page:true,limit:10,limits:[10,15,20,25,30,50],id:'manage'}" lay-filter="manage">
        <thead>
        <tr>
    ...
    layui.use(["laydate","laypage","element","layer","table","jquery","form"],function () {
        ...
        table.on('tool(manage)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么',{offset:'10px',anim:1,btn:['确定','再考虑一下']},function(index){
                    $.ajax({
                        ...
                        success:function (res) {
                            ...
                            return layer.alert(res.msg,{offset:'10px'});
                        },
                        error:function (kj) {
                ...
                layer.open({
                    type:2,
                    content:'./showTask?taid='+data.taid,
                    area:['90%','80%'],
                    title:'任务',
                    offset:'10px'
                });
                ...
                layer.open({
                    type:2,
                    content:'./showTask_all?taid='+data.taid,
                    area:['90%','80%'],
                    title:'任务',
                    offset:'10px'
                });
