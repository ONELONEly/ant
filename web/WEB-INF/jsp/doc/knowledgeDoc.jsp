...
<div class="x-body">
    ...
    <table class="layui-table" lay-skin="nob" lay-data="{url:'./queryAllMessage?ctyp=4',id:'manage'}" lay-filter="manage">
        <thead>
        <tr>
            <th lay-data="{field:'tilt',align:'center',width:'50%',toolbar:'#noteTpl'}">标题</th>
            <th lay-data="{field:'unam',align:'center',width:'30%'}">创建人</th>
            <th lay-data="{field:'cdat',align:'center',width:'20%'}">创建时间</th>
        </tr>
        </thead>
    </table>
