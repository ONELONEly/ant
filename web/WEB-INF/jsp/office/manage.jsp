...
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{height:'full-400',url:'${base}/acco/queryAllAcco',page:true,limit:10,limits:[10,15,20,25,30,50],id:'office'}" lay-filter="office">
        <thead>
        <tr>
            <th lay-data="{checkbox:true,width:50,fixed:true}"></th>
            <th lay-data="{field:'acco',width:150,sort:true}">科室编号</th>
